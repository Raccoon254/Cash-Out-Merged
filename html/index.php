...
You can watch ads and get paid.<span class="badge bg-warning">Coming Soon</span><br>
                ...
                <ul class="p-0 m-0">';
                    ...
                    <li class="d-flex mb-4 pb-1">
                        <div class="avatar flex-shrink-0 me-3">
                            <img src="../assets/img/icons/unicons/';
  echo " $type"; echo '.png" alt="User" class="rounded" />
                        </div>
                    ...
                    ' ; } else { echo 'Your Transactions Will Appear Here' ; } echo '
                </ul>
            </div>
        </div>
    </div>
