                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img width="200px" src="../assets/img/raccoon/dp.png" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
                ...
                <div class="row">
                  ...
                  echo '<div class="card mb-4">
                                      <div class="card-body">
                                        ...
                                        <div class="card-subtitle text-muted mb-3">Activation</div>
                                        <p class="card-text">
                                          Enter Your contact to activate account.
                                        </p>
                                        
                      <div class="form-floating">
                        <form action="settings.php" method="post">
                        <input type="text" name="contact" class="form-control" id="floatingInput" placeholder="07XXXXXXXX" aria-describedby="floatingInputHelp">
                        <label for="floatingInput">Contact</label>
                        <div id="floatingInputHelp" class="form-text">
                          We';echo"'";echo'll never share your details with anyone else.<br>
                          <input type="submit" name="verify" class="btn mt-2 rounded-pill btn-primary" value="verify">
                        </form>
                        ...
                        //  $phone_number = $_POST['contact'];
                          function remove_leading_zero($number) {
                            return '254' . substr($number, 1);
                        }
                        
                        $number = $_POST['contact'];
                        $phone_number = remove_leading_zero($number);
