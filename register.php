        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            if ($result) {
                ...
                if ($referral_code) {
                    ...
                    $resultUser = mysqli_query($conn, $emailAssocUserQuery);
                    ...
                    $result = mysqli_query($conn, $transactionUpdateOne);
                    $result = mysqli_query($conn, $transactionUpdateTwo);
                    $result = mysqli_query($conn, $transactionUpdateCurrent);

                    $result = mysqli_query($conn, $earningsUpdateDetails);
                    $result = mysqli_query($conn, $queryUpdateForSecondLevel);
